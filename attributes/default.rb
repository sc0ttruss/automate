...
# Need chef supermarket url
default['automate']['supermarket_server_fqdn'] = 'https://supermarket.myorg.chefdemo.net'
...
default['automate']['build_node']['installer'] = "/opt/delivery/#{node['automate']['chefdk']['redhat']}"
# not implemented in this script but you can use it
# need to add the ''--ssh_identity_file' switch to the
# 'delivery-ctl install-build-node' command
